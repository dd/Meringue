...
class GetAbsoluteUrlMixin(object):
    ...
    '''
        ...
        host_name - название верхнего модуля в нижнем регистре (используется
            в случае установенного django_hosts)
        view - '<namespace>:<url_name>'
            namespace - название приложения приведённое к нижнему регистру
                и точки заменённые на нижнее подчёркивание
            url_name - название класса приведённое к нижнему регистру с
                приставкой '-detail'
